...
describe("./message/twitch-types/privmsg", function () {
    ...
    describe("PrivmsgMessage", function () {
        ...
        it('should be able to parse a reply PRIVMSG message that has the reply message body "foo=bar"', function () {
            const msgText = "@badge-info=;badges=;client-nonce=094fcf39e387204709c4cacb85d264e5;color=;display-name=survivedby_bot;emotes=;" +
            ...
            chai_1.assert.instanceOf(msg, privmsg_1.PrivmsgMessage);
            chai_1.assert.isTrue(msg.isReply());
            chai_1.assert.strictEqual(msg.replyParentDisplayName, "SomeUser");
            chai_1.assert.strictEqual(msg.replyParentMessageBody, "foo=bar");
            chai_1.assert.strictEqual(msg.replyParentMessageID, "725d8358-d934-42c7-a606-a0b3ed82a642");
            chai_1.assert.strictEqual(msg.replyParentUserID, "441347665");
            chai_1.assert.strictEqual(msg.replyParentUserLogin, "someuser");
        });
    });
});
