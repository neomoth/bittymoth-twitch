...
class ChatClient extends base_client_1.BaseClient {
    ...
    constructor(configuration) {
        ...
        if (this.configuration.installDefaultMixins) {
            ...
            this.use(new join_1.JoinRateLimiter(this));
        }
    ...
    async joinAll(channelNames) {
        ...
        const needToJoin = channelNames.filter((channelName) => !this.connections.some((c) => (0, join_2.joinNothingToDo)(c, channelName)));
        const promises = [];
        let idx = 0;
